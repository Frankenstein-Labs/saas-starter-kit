...
_Analyse basée sur l’état du dépôt inspecté le 20 septembre 2026, notamment `README.md`, `package.json`, `.env.example`, `prisma/schema.prisma`, `pages/`, `components/`, `models/` et `lib/`._
